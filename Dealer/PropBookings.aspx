<%@ Page Title="" Language="C#" MasterPageFile="~/Dealer/DealerMaster.master" AutoEventWireup="true" CodeFile="PropBookings.aspx.cs" Inherits="Dealer_Default" %>
...
<div class="dashboard">
			                        ...
			                        <div class="property-block">
			                        	<div class="inner-box clearfix">
		                                    ...
		                                    <div class="option-box">
		                                        <div class="expire-date"><i style="font-size:24px" class="fa">&#xf156;</i><%#Eval("Bamt") %></div>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server"  ConnectionString="<%$ ConnectionStrings:ConnectionString %>" >
                            <SelectParameters>
                                <asp:SessionParameter SessionField="did" Name="Id" Type="Int32"></asp:SessionParameter>
                            </SelectParameters>
                        </asp:SqlDataSource>
  </body>
       </html>  
