<%@ Page Title="" Language="C#" MasterPageFile="~/Dealer/DealerMaster.master" AutoEventWireup="true" CodeFile="DMyProfile.aspx.cs" Inherits="Dealer_Default" %>
		                                        ...
		                                        <div class="edit-profile-photo">
		                                           ...
		                                           <%--<div class="change-photo-btn">--%>
		                                               <div>
                                                           ...
                                                           <asp:FileUpload ID="FileUpload1" runat="server" text="Upload"   ToolTip="Choose Your Image" /> 
	                    					...
	                    					<div class="col-lg-8 col-md-12 col-sm-12">
					                                ...
					                                <div class="row">
					                                    ...
					                                    <div class="form-group text-right col-lg-12 col-md-12 col-sm-12">
                                                            ...
                                                            <asp:Button ID="btnup" BackColor="#3366FF" OnClick="btnup_Click" runat="server" class="theme-btn btn-style-one" Text="Update Profile"  />
                                                            <asp:Label ID="lblfill" runat="server" Text="Please Fillup all details" ForeColor="Red" Visible="false"></asp:Label>
					                                    </div>
					                                </div>
	                    			...
	                    			<div class="profile-form">
			                                ...
			                                <div class="row">
			                                    ...
			                                    <div class="form-group col-lg-12">
                                                    ...
                                                    <asp:TextBox ID="txtcp" placeholder="Current Password" runat="server"></asp:TextBox>
			                                    </div>
			                                    ...
			                                    <div class="form-group col-lg-12">
                                                    ...
                                                    <asp:TextBox ID="txtnp" placeholder="New Password" runat="server"></asp:TextBox>
			                                    ...
			                                    <div class="form-group col-lg-12">
			                                        ...
			                                        <%--<input type="text" name="phone" placeholder="Confirm New Password" required>--%>
                                                     <asp:TextBox ID="txtcnp" placeholder="Confirm New Password" runat="server"></asp:TextBox>
			                                    ...
			                                    <div class="form-group col-lg-12">
                                                    ...
                                                    <asp:Button ID="btnupd" runat="server" OnClick="btnupd_Click" class="theme-btn btn-style-one" Text="Update Password" BackColor="#3366FF"  />
			                                    </div>
			                                </div>
