<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="AddBuilders.aspx.cs" Inherits="Admin_Default" %>
			                               ...
			                               <div class="title"><h3>Image</h3></div>
			                                ...
			                                <div class="row">
			                                    ...
			                                    <div class="form-group col-lg-3 col-md-6 col-sm-12">
                                                    ...
                                                    <asp:Button ID="btnadd" class="theme-btn btn-style-one" runat="server" Width="150" Text="Add" OnClick="btnadd_Click" />
		                                        </div>
                                    </div>
                                </div>
                            </div>
