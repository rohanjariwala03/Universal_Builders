                    					...
                    					<div class="row">
		                                        ...
		                                        <div class="edit-profile-photo">
		                                           ...
		                                           <%--<div class="change-photo-btn">--%>
		                                               <div class="photoUpload">
                                                           ...
                                                           <asp:FileUpload ID="FileUpload1" runat="server" text="Upload" onchange="ImagePreview(this);"  ToolTip="Choose Your Image" /> 
	                    					...
	                    					<div class="col-lg-8 col-md-12 col-sm-12">
					                                ...
					                                <div class="row">
					                                   ...
					                                   <asp:Label ID="lblfill" runat="server" Text="Please Fill all details" ForeColor="Red" Visible="false"></asp:Label>
                                                             </div>
					                                </div>
