<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="ContactUsDetails.aspx.cs" Inherits="Admin_Default" %>
	                    		...
	                    		<div class="inner-box">
	                                ...
	                                <article class="message-box">
                                       ...
                                       <%-- <div class="name"><asp:label ID="Label1" runat="server" Text="Name:- "><%#Eval("ConatctName") %></asp:label></div>
                                            ...
                                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="ContactId" DataSourceID="SqlDataSource1" CellPadding="4" ForeColor="#333333" GridLines="None" Height="236px" Width="965px">
                                                <AlternatingRowStyle BackColor="White" />
                                                <Columns>
                                                    <asp:BoundField DataField="ContactId" HeaderText="ID" InsertVisible="False" ReadOnly="True" SortExpression="ContactId" />
                                                    <asp:BoundField DataField="ConatctName" HeaderText="NAME" SortExpression="ConatctName" />
                                                    <asp:BoundField DataField="ContactMessage" HeaderText="MESSAGE" SortExpression="ContactMessage" />
                                                    <asp:BoundField DataField="ContactEmail" HeaderText="EMAIL" SortExpression="ContactEmail" />
                                                    <asp:BoundField DataField="ConatactSubject" HeaderText="SUBJECT" SortExpression="ConatactSubject" />
                                                    
                                                     <asp:HyperLinkField DataNavigateUrlFields="Contactid" DataNavigateUrlFormatString="Rply.aspx?rpid={0}" HeaderText="Rply" Text="Rply" />
