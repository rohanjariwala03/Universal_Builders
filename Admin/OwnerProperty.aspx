<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="OwnerProperty.aspx.cs" Inherits="Admin_Default" %>
...
<%--<i style="font-size:24px" class="fa">&#xf156;</i>--%>
			                        	...
			                        	<div class="inner-box clearfix">
		                                    ...
		                                    <div class="option-box">
		                                        ...
		                                        <ul class="action-list">
		                                        	...
		                                        	<li><%--<a href="#">--%><i class="la la-trash-o"><a href='DeletePro.aspx?proid=<%#Eval("pid") %>'>Delete</a></i> <%--Delete</a>--%></li>
		                                        </ul>
		                                    </div>
			                        	</div>
                                    </div>                    		
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [Pid],[Paddress], [Pimg], [Pname], [TotalSquareFeet], [Bedroom], [Bathroom], [Status], [Kitchen], [TotalPrice] FROM [PropertyOwner]"></asp:SqlDataSource>
