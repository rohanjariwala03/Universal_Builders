<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="Bookings.aspx.cs" Inherits="Admin_Default" %>
	                    		...
	                    		<div class="inner-box">
	                                ...
	                                <article class="message-box">
                                       ...
                                       <%-- <div class="name"><asp:label ID="Label1" runat="server" Text="Name:- "><%#Eval("ConatctName") %></asp:label></div>
                                            ...
                                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="Boid" DataSourceID="SqlDataSource1" CellPadding="4" ForeColor="#333333" GridLines="None" Height="236px" Width="965px">
                                                <AlternatingRowStyle BackColor="White" />
                                                <Columns>
                                                    <asp:BoundField DataField="Boid" HeaderText="Boid" InsertVisible="False" ReadOnly="True" SortExpression="Boid" />
                                                    <asp:BoundField DataField="Uid" HeaderText="Uid" SortExpression="Uid" />
                                                    <asp:BoundField DataField="Pid" HeaderText="Pid" SortExpression="Pid" />
                                                    <asp:BoundField DataField="Bamt" HeaderText="Bamt" SortExpression="Bamt" />
	                                        ...
	                                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString2 %>" SelectCommand="SELECT [Boid], [Uid], [Pid], [Bamt] FROM [Booking]"></asp:SqlDataSource>
	                                </article>
