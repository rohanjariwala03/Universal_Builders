<%@ Page Title="" Language="C#" MasterPageFile="~/User/UserMaster.master" AutoEventWireup="true" CodeFile="PropertyListview.aspx.cs" Inherits="User_Default" %>
    ...
    <section class="page-title" style="background-image:url(images/background/16.jpg);">
        <div class="auto-container">
            <div class="inner-container clearfix">
                <h1>Favourite Property List</h1>
                <ul class="bread-crumb clearfix">
                    <li><a href="index-2.html">Home</a></li>
                    <li>Favourite Property List</li>
                </ul>
            </div>
        </div>
    </section>
            ...
            <div class="row clearfix">
                ...
                <div class="content-side col-lg-8 col-md-12 col-sm-12">
                    <div class="property-list-view">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [Pname], [Pdesc], [Ptype], [PCat], [Bedroom], [Pid], [Bathroom], [Kitchen], [TotalSquareFeet], [PerFeetPrice], [TotalPrice], [Paddress], [OwnerType], [Pimg], [Pvideo], [Cid], [sid], [Ciid], [Status] FROM [PropertyOwner] WHERE ([Status] = @Status)">
                             <SelectParameters>
