<%@ Page Title="" Language="C#" MasterPageFile="~/User/UserMaster.master" AutoEventWireup="true" CodeFile="UPropBookings.aspx.cs" Inherits="User_Default" %>
    ...
    <section class="page-title" style="background-image:url(images/background/16.jpg);">
        <div class="auto-container">
            <div class="inner-container clearfix">
                <h1>My Property Booking List</h1>
                <ul class="bread-crumb clearfix">
                    <li><a href="Index.aspx">Home</a></li>
                    <li>My Property Booking List</li>
                </ul>
            </div>
        </div>
    </section>
                    ...
                    <div class="property-list-view">
                        <div class="upper-box clearfix">
                            <div class="sec-title">
                                ...
                                <h2>My Property Booking List</h2>
                            </div>
