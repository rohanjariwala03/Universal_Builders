...
public partial class User_Default3 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //    drsr.DataSource = dt;
        //    drsr.DataBind();
        //    drsr.DataTextField = "PCatName";
        //    drsr.DataValueField = "PCatId";
        //    drsr.DataBind();
        //    cn.Close();
        //}
    }
    ...
    {
        if (txtpname.Text == "" ||txtadd.Text == ""||txtdi.Text == ""||txtfeet.Text == ""||txtfeetprice.Text == ""||txtpin.Text == ""||drptype.SelectedValue == "1" ||FileUploadImg1.FileName == ""||fl1.FileName==""||drbed.SelectedValue == "Bed Room" ||drsr.SelectedValue == "1"||drkit.SelectedValue == "Kitchen"||drbat.SelectedValue == "Bathroom")
        {
        ...
        else
        {
            ...
            //{
                ...
                else if (drptype.SelectedValue == "4")
                {
                    userid = Session["uid"].ToString();
                    ownType = "Owner";
                    qry = "insert into PropertyOwner(Pname,Pdesc,Ptype,PCat,Bedroom,Bathroom,Kitchen,HouseNo,TotalFlore,FloreNo,TotalSquareFeet,PerFeetPrice,TotalPrice,Paddress,OwnerType,OwnerId,Pimg,Cid,sid,Ciid,status) values('" + txtpname.Text + "','" + txtdi.Text + "','" + drptype.SelectedItem.Text + "','" + drsr.SelectedItem.Text + "','" + drbed.SelectedItem.Text + "','" + drbat.SelectedItem.Text + "','" + drkit.SelectedItem.Text + "','" + txthouseno.Text + "','" + txtflore.Text + "','" + txtfloreno.Text + "','" + txtfeet.Text + "','" + txtfeetprice.Text + "','" + txttotprice.Text + "','" + txtadd.Text + "','" + ownType + "','" + userid + "','" + fl1.FileName + "','" + "1" + "','" + drst.SelectedItem.Value + "','" + drct.SelectedItem.Value + "','" + 1 + "')";
                    SqlCommand cmd = new SqlCommand(qry, cn);
                    cmd.ExecuteNonQuery();
                    string path = Path.GetFileName(fl1.FileName);
                    path = path.Replace(" ", "");
    ...
    {
        txtpname.Text = drptype.SelectedValue;
        if (drptype.SelectedValue == "3")
        {
