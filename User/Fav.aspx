<%@ Page Title="" Language="C#" MasterPageFile="~/User/UserMaster.master" AutoEventWireup="true" CodeFile="Fav.aspx.cs" Inherits="User_Default" %>
            ...
            <div class="row clearfix">
                ...
                <div class="content-side col-lg-8 col-md-12 col-sm-12">
                    <div class="property-list-view">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="column col-xl-6 col-lg-12 col-md-12 col-sm-12">
                                        <div class="lower-content">
                                            ...
                                            <div class="property-price clearfix">
                                                <center> <div class="read-more"><a href="FavRemove.aspx?proid=<%#Eval("Pid") %>" class="theme-btn">Remove</a></div></center>
                                                </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT PropertyOwner.Pname, PropertyOwner.Pdesc, PropertyOwner.Ptype, PropertyOwner.PCat, PropertyOwner.Bedroom, PropertyOwner.Bathroom, PropertyOwner.Kitchen, PropertyOwner.TotalSquareFeet, PropertyOwner.PerFeetPrice, PropertyOwner.TotalPrice, PropertyOwner.Paddress, PropertyOwner.Pimg, PropertyOwner.Status, Fav.Pid, Fav.Uid FROM PropertyOwner INNER JOIN Fav ON PropertyOwner.Pid = Fav.Pid"></asp:SqlDataSource>
