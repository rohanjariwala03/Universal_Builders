<%@ Page Title="" Language="C#" MasterPageFile="~/Builder/BuilderMaster.master" AutoEventWireup="true" CodeFile="BMyProfile.aspx.cs" Inherits="Builder_Default" %>
	                    					...
	                    					<div class="col-lg-8 col-md-12 col-sm-12">
					                                ...
					                                <div class="row">
					                                    ...
					                                    <div class="form-group text-right col-lg-12 col-md-12 col-sm-12">
					                                        ...
					                                        <asp:Label ID="lblfill" runat="server" Text="Please Fill up details" ForeColor="Red" Visible="false"></asp:Label>
                                                        </div>
					                                </div>
